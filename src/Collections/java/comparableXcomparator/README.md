...
class Livro implements Comparable<Collections.java.comparableXcomparator.Livro> {
    ...
    public int compareTo(Collections.java.comparableXcomparator.Livro l) {
...
class CompararAutor implements Comparator<Collections.java.comparableXcomparator.Livro> {
    @Override
    public int compare(Collections.java.comparableXcomparator.Livro l1, Collections.java.comparableXcomparator.Livro l2) {
        return l1.getAutor().compareTo(l2.getAutor());
    }
}

// Classe para comparar Livro por ano
class CompararAno implements Comparator<Collections.java.comparableXcomparator.Livro> {
    @Override
    public int compare(Collections.java.comparableXcomparator.Livro l1, Collections.java.comparableXcomparator.Livro l2) {
...
class CompararAnoAutorTitulo implements Comparator<Collections.java.comparableXcomparator.Livro> {
    @Override
    public int compare(Collections.java.comparableXcomparator.Livro l1, Collections.java.comparableXcomparator.Livro l2) {
